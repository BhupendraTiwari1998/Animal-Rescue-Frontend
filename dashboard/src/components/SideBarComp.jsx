          ...
          <div style={{display:'flex',justifyContent:'space-between',padding:'0 10px',alignItems:'center'}}>
            <Toolbar>
              ...
              <Typography variant="h6" noWrap component="div">
                <img src="https://animal-rescue.cmsmasters.net/pet-shelter/wp-content/uploads/sites/5/2022/11/logo-pet-shelter.svg" alt="" />

              </Typography>
            </Toolbar>
            <Button className='btn21' onClick={clickHand}> Log Out</Button>
          </div>
        </AppBar>
        <Drawer
          sx={{
